      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-8 gap-4 mt-4">
        {currentSongs.map((song, index) => (
          <div key={index} className="category-image">
            <button
              className="loved"
              onClick={() => console.log("Add to favorites", song)}
            >
              <FaRegHeart />
              *Fav
            </button>
            ...
            >
              ...
              <div className="absolute bottom-24 right-5">
                <button className="transition opacity-0 rounded-full flex items-center bg-green-500 p-4 drop-shodow-md translate translate-y-1/4 group-hover:opacity-100 group-hover:translate-y-0 hover:scale-110">
